import {parseTimelineCSV,prepareInput} from './preprocess.js?v=11.1';
import {ModelRuntime} from './model.js?v=11.1';
import {DonorRuntime} from './donor.js?v=11.1';
import {evaluatePolicy,applyTemporal,newTemporalState} from './policy.js';
import {runBrowserSelfTest} from './selftest.js?v=11.1';
...
async function run(e){
  ...
  $('runBtn').querySelector('span').textContent='Running the calculator…';
