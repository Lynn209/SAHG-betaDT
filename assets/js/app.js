import {parseTimelineCSV,prepareInput} from './preprocess.js?v=7.1';
import {ModelRuntime} from './model.js?v=7.1';
import {DonorRuntime} from './donor.js?v=7.1';
import {evaluatePolicy,applyTemporal,newTemporalState} from './policy.js';
import {runBrowserSelfTest} from './selftest.js?v=7.1';
...
async function run(e){
  ...
  setText('readyHint','Running the frozen V17 calculator locally in this browser…');
